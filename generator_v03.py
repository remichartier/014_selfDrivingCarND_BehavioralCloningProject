...
# v03 : migrate model from model_v12.py to generator_v03.py
...
checkpoint = ModelCheckpoint(filepath='bestModelFolder/model.{epoch:02d}-{val_loss:.4f}.h5', monitor='val_loss', save_best_only=True)
