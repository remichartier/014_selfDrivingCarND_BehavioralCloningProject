...
# v15 : use commonFunction_v14 with steering correction bug fix to test if still passing
#       + load latest best model 
#       20201231_0002_modelv15_model.10-Loss0.0208-valLoss0.0195.h5
...
from commonFunctions_v14 import get_lines_logfile 
from commonFunctions_v14 import generator
...
#model.load_weights("20201213_1400_modelv13_model.02-Loss0.0081-valLoss0.0093.h5") 
model.load_weights("20201231_0002_modelv15_model.10-Loss0.0208-valLoss0.0195.h5") 
